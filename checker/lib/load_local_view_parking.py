...
ego_init_y = 0.0
class LoadCyberbag:
  def __init__(self, path, use_ver_250=True, parking_flag = False) -> None:
    global version_250
    version_250 = use_ver_250
  ...
  def load_all_data(self):
    ...
    try:
      ...
      if len(self.loc_msg['t']) > 0:
        ...
        smallest_abs_t = max(smallest_abs_t, self.loc_msg['abs_t'][0])
      else:
    ...
    try:
      ...
      if len(self.vs_msg['t']) > 0:
        self.vs_msg['enable'] = True
        smallest_abs_t = min(smallest_abs_t, self.vs_msg['abs_t'][0])
      else:
    ...
    try:
      ...
      if len(self.plan_msg['t']) > 0:
        ...
        smallest_abs_t = min(smallest_abs_t, self.plan_msg['abs_t'][0])
      else:
    ...
    try:
      json_value_list = ["tlane_p0_x", "tlane_p0_y", "tlane_p1_x", "tlane_p1_y", "tlane_pt_x", "tlane_pt_y", "slot_side",
                         ...
                         "car_static_timer_by_pos_strict", "car_static_timer_by_pos_normal", "car_static_timer_by_vel_strict", "car_static_timer_by_vel_normal", "static_flag", "ego_heading_slot", "local_move_dist", "local_vel",
      ...
      if len(self.plan_debug_msg['t']) > 0:
        ...
        smallest_abs_t = min(smallest_abs_t, self.plan_debug_msg['abs_t'][0])
      else:
    ...
    try:
      ...
      if len(self.ctrl_msg['t']) > 0:
        ...
        smallest_abs_t = min(smallest_abs_t, self.ctrl_msg['abs_t'][0])
      else:
    ...
    try:
      ...
      if len(self.ctrl_debug_msg['t']) > 0:
        ...
        smallest_abs_t = min(smallest_abs_t, self.ctrl_debug_msg['abs_t'][0])
      else:
    ...
    try:
      ...
      if len(self.fus_parking_msg['t']) > 0:
        ...
        smallest_abs_t = min(smallest_abs_t, self.fus_parking_msg['abs_t'][0])
      else:
    ...
    try:
      ...
      if len(self.fus_ground_line_msg['t']) > 0:
        ...
        smallest_abs_t = min(smallest_abs_t, self.fus_ground_line_msg['abs_t'][0])
      else:
    ...
    try:
      ...
      if len(self.fus_objects_msg['t']) > 0:
        ...
        if (self.fus_objects_msg['abs_t'][0] < 0.001):
          smallest_abs_t = min(smallest_abs_t, self.fus_objects_msg['abs_t'][1])
        else:
          smallest_abs_t = min(smallest_abs_t, self.fus_objects_msg['abs_t'][0])
      else:
    ...
    # load fusion occupancy objects msg
    try:
      ...
      if len(self.fus_occupancy_objects_msg['t']) > 0:
        ...
        if (self.fus_occupancy_objects_msg['abs_t'][0] < 0.001):
          smallest_abs_t = min(smallest_abs_t, self.fus_occupancy_objects_msg['abs_t'][1])
        else:
          smallest_abs_t = min(smallest_abs_t, self.fus_occupancy_objects_msg['abs_t'][0])
      else:
    ...
    try:
      ...
      if len(self.vis_parking_msg['t']) > 2:
        ...
        smallest_abs_t = min(smallest_abs_t, self.vis_parking_msg['abs_t'][0])
      else:
    ...
    try:
      ...
      if len(self.soc_state_msg['t']) > 0:
        ...
        smallest_abs_t = min(smallest_abs_t, self.soc_state_msg['abs_t'][0])
      else:
    ...
    try:
      ...
      if len(self.wave_msg['t']) > 0:
        self.wave_msg['enable'] = True
        smallest_abs_t = min(smallest_abs_t, self.wave_msg['abs_t'][0])
      else:
   ...
   #load adas_debug_msg
    try:
      ...
      if len(self.adas_debug_msg['t']) > 0:
        self.adas_debug_msg['enable'] = True
        smallest_abs_t = min(smallest_abs_t, self.adas_debug_msg['abs_t'][0])
      else:
    ...
    try:
      ...
      if len(self.wave_debug_msg['t']) > 0:
        self.wave_debug_msg['enable'] = True
        smallest_abs_t = min(smallest_abs_t, self.wave_debug_msg['abs_t'][0])
      else:
    ...
    try:
      ...
      if len(self.uss_percept_msg['t']) > 0:
        self.uss_percept_msg['enable'] = True
        smallest_abs_t = min(smallest_abs_t, self.uss_percept_msg['abs_t'][0])
      else:
        self.uss_percept_msg['enable'] = False
    except:
      self.uss_percept_msg['enable'] = False
      print("missing /iflytek/uss_perception_info !!!")
...
def update_local_view_data_parking(fig1, bag_loader, bag_time, vehicle_type, local_view_data, plot_ctrl_flag=False):
  ...
  if bag_loader.uss_percept_msg['enable'] == True and bag_loader.loc_msg['enable'] == True and load_uss_wave_from_uss_percept_msg:
    ...
    for i in range(2):
      for j in wdis_index[i]:
          rs0 = ''
          rs1 = ''
          if uss_dis_info[j] * 0.001 <= 10 and uss_dis_info[i] * 0.001 > -1e-2:
          ...
          elif uss_dis_info[j] * 0.001 < -1e-2 or uss_dis_info[j] * 0.001 > 10:
    ...
    for i in range(2):
      for j in wdis_index[i]:
          rs0 = ''
          rs1 = ''
          if upa_dis_info_bufs[i].wdis[j].wdis_value[0] <= 10 and upa_dis_info_bufs[i].wdis[j].wdis_value[0] > -1e-2:
              ...
              uss_angle_end = math.radians(uss_angle[m] +30) + cur_yaw
              x_text, y_text = one_echo_text_local(ego_local_x, ego_local_y, math.radians(uss_angle[m] - 90) + cur_yaw, rs1 - 0.5)
          elif upa_dis_info_bufs[i].wdis[j].wdis_value[0] < -1e-2 or upa_dis_info_bufs[i].wdis[j].wdis_value[0] > 10:
              ego_local_x, ego_local_y, uss_angle_start, uss_angle_end = '', '', '', ''
              x_text, y_text = 0, 0
          text_x.append(x_text)
          text_y.append(y_text)
  ...
  if bag_loader.fus_occupancy_objects_msg['enable'] == True and load_fusion_object_from_occupancy:
    ...
    fusion_object_num = 0
    if version_250:
      fusion_object_num = bag_loader.fus_occupancy_objects_msg['data'][fus_occupancy_objects_msg_idx].fusion_object_size
    else:
      fusion_object_num = bag_loader.fus_occupancy_objects_msg['data'][fus_occupancy_objects_msg_idx].fusion_object_num
    ...
    for i in range(fusion_object_num):
      ...
      num = 0
      if version_250:
        num = obj.additional_occupancy_info.polygon_points_size
      else:
        num = obj.additional_occupancy_info.polygon_points_num
      for j in range(num):
    ...
    fusion_object_num = 0
    if version_250:
      fusion_object_num = bag_loader.fus_objects_msg['data'][fus_objects_msg_idx].fusion_object_size
    else:
      fusion_object_num = bag_loader.fus_objects_msg['data'][fus_objects_msg_idx].fusion_object_num
...
def load_local_view_figure_parking():
 ...
 ### figures config
  ...
  fig1.circle('corner_point_y', 'corner_point_x', source = data_planning_pose, size=6, color='black', legend_label = 'plan_pose')
...
def apa_draw_local_view(dataLoader, layer_manager, max_time, time_step, vehicle_type, plot_ctrl_flag=False):
    ...
    fig_local_view = bkp.figure(x_axis_label='y', y_axis_label='x', width=1000, height=1000, match_aspect = False, aspect_scale=1, y_range=(ego_init_x - 20.0, ego_init_x + 20.0), x_range=(ego_init_y + 20.0, ego_init_y - 20.0))
  ...
  # load self car info
    ...
    front_current_line_generate = CommonGenerator()
    for localization_timestamp in localization_timestamps:
      ...
      current_line_xn = []
      current_line_yn = []
      front_current_line_xn = []
      front_current_line_yn = []
      ...
      if not flag:
        ...
        x4 = x2 + norm_vec_3[0]
        y4 = y2 + norm_vec_3[1]
        front_current_line_xn = [x3, x4]
        front_current_line_yn = [y3, y4]
        # car pos
      ...
      front_current_line_generate.xys.append((front_current_line_yn,front_current_line_xn))
    ...
    front_current_line_generate.ts = np.array(ctrl_debug_ts)
  # load location
    ...
    for loc_i, localization_timestamp in enumerate(localization_timestamps):
      ...
      if not flag:
        ...
        if version_250:
          ...
          vel_ego =  dataLoader.loc_msg['data'][loc_msg_idx].pose.linear_velocity_from_wheel
        ...
        selected_slot_id = 0
        if dataLoader.fus_parking_msg['enable'] == True:
          flag, fus_parking_msg = findt(dataLoader.fus_parking_msg, fusion_slot_timestamps[loc_i])
          selected_slot_id = fus_parking_msg.select_slot_id

        abs_t_string = time.strftime("%Y-%m-%d %H:%M:%S", time.localtime(localization_timestamp))
        text = 'v = {:.2f} m/s, remain_s_ctrl = {:.1f} cm, steer = {:.1f} deg, state = {:d}, selected_slot_id = {:d}, time = {:s}, abs_t = {:} s'.format(round(vel_ego, 2), round(remain_s_ctrl, 1), round(steer_deg, 1), current_state, selected_slot_id, abs_t_string, round(localization_timestamp, 1))
            ...
            if not flag:
              ...
              for j in range(parking_slots_size):
                  ...
                  for corner_point in slot.corner_points:
                    ...
                    corner_x_global, corner_y_global = local2global(corner_x_local, corner_y_local, cur_pos_xn, cur_pos_yn, cur_pos_theta)
              ...
              for limiter in vision_slot_limiters:
                global_limiter_x0, global_limiter_y0 = local2global(limiter.limiter_points[0].x, limiter.limiter_points[0].y, cur_pos_xn, cur_pos_yn, cur_pos_theta)
                global_limiter_x1, global_limiter_y1 = local2global(limiter.limiter_points[1].x, limiter.limiter_points[1].y, cur_pos_xn, cur_pos_yn, cur_pos_theta)
  ...
  # load planning traj
    ...
    front_target_line_generator = CommonGenerator()
    ...
    for plan_i, plan_timestamp in enumerate(plan_output_timestamps):
      ...
      if not flag:
        ...
        front_target_line_xn, front_target_line_yn = [], []
        ...
        if (len(plan_traj_x) > 1):
          ...
          x4 = x2 + norm_vec_3[0]
          y4 = y2 + norm_vec_3[1]
          front_target_line_xn = [x3, x4]
          front_target_line_yn = [y3, y4]
          ...
          plan_traj_lat_buffert_vec = plan_json['plan_traj_lat_buffer']
          if len(plan_traj_x_vec) < 21:
      ...
      front_target_line_generator.xys.append((front_target_line_yn,front_target_line_xn))
    ...
    front_target_line_generator.ts = np.array(ctrl_debug_ts)
      ...
      if not flag:
        ...
        if not flag:
          ...
          if version_250:
            ...
            cur_pos_yn = loc_msg.pose.local_position.y
            cur_pos_theta = loc_msg.pose.euler_angles.yaw
          coord_tf.set_info(cur_pos_xn, cur_pos_yn, cur_pos_theta)
    ...
    for fus_obj_i, fus_occupancy_objects_timestamp in enumerate(fus_occupancy_objects_timestamps):
      if dataLoader.fus_occupancy_objects_msg['enable'] == True and load_fusion_object_from_occupancy:
        ...
        if not flag:
          ...
          if version_250:
            fusion_object_num = fus_occupancy_objects_msg.fusion_object_size
          else:
            fusion_object_num = fus_occupancy_objects_msg.fusion_object_num
        ...
        if not flag:
          ...
          if version_250:
            fusion_object_num = dataLoader.fus_objects_msg['data'][fus_objects_msg_idx].fusion_object_size
          else:
            fusion_object_num = dataLoader.fus_objects_msg['data'][fus_objects_msg_idx].fusion_object_num
          for i in range(fusion_object_num):
            obj = fus_objects_msg.fusion_object[i]
            polygon_points = obj.additional_info.polygon_points
            num = 0
            if version_250:
              num = obj.additional_info.polygon_points_size
            else:
              num = obj.additional_info.polygon_points_num
            for j in range(num):
              x = polygon_points[j].x
              y = polygon_points[j].y
              pos_x.append(x)
            ...
            for i in range(2):
              for j in wdis_index[i]:
                  ...
                  if uss_dis_info[j] * 0.001 <= 10 and uss_dis_info[i] * 0.001 > -1e-2:
                      ...
                      # rs0 = '{:.2f}\n{:.2f}'.format(round(upa_dis_info_bufs[i].wdis[j].wdis_value[0], 2), round(upa_dis_info_bufs[i].wtype[j].wtype_value[0]))
                      rs0 = '{:.2f}'.format(round(uss_dis_info[j] * 0.001, 2))
                      ego_local_x, ego_local_y= local2global(uss_x[m], uss_y[m], cur_pos_xn, cur_pos_yn, cur_pos_theta)
                      uss_angle_start = math.radians(uss_angle[m] - 30) + cur_pos_theta
                      uss_angle_end = math.radians(uss_angle[m] +30) + cur_pos_theta
                      x_text, y_text = one_echo_text_local(ego_local_x, ego_local_y, math.radians(uss_angle[m] - 90) + cur_pos_theta, rs1 - 0.5)
                  elif uss_dis_info[j] * 0.001 < -1e-2 or uss_dis_info[j] * 0.001 > 10:
                      ego_local_x, ego_local_y, uss_angle_start, uss_angle_end = '', '', '', ''
                      x_text, y_text = 0, 0
                  text_x.append(x_text)
  ...
  # move Layer here for manage
    ...
    if dataLoader.plan_msg['enable'] == True:
      ...
      front_target_line_layer = CurveLayer(fig_local_view, front_target_line_params)
      layer_manager.AddLayer(front_target_line_layer, 'front_target_line_layer', front_target_line_generator, 'front_target_line_generator', 2)
    ...
    if dataLoader.loc_msg['enable'] == True:
      ...
      front_current_line_layer = CurveLayer(fig_local_view, front_current_line_params)
      layer_manager.AddLayer(front_current_line_layer, 'front_current_line_layer', front_current_line_generate, 'front_current_line_generate', 2)
    # uss
